...
public interface TratamientoService{
    ...
    Tratamiento crearTratamiento(Tratamiento tratamiento, Integer idMascota, Integer idServicio, Integer idVeterinario, List<MedicamentoCantidadDTO> medicamentosCantidad);
